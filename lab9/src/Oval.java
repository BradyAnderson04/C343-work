...
public class Oval extends Shape{
	...
	public Oval(Color fillColor,Color borderColor, int x, int y, double length, double width, int dx, int dy) {
	...
	public Oval(Color fillColor, int x, int y,double length, double width, int dx, int dy) {
